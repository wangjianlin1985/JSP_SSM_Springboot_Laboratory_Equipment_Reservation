...
public class TeacherService {
    ...
    /*按照查询条件分页查询教师记录*/
    public ArrayList<Teacher> queryTeacher(String telephone,String teacherNo,String teacherName,String inDate,int currentPage) throws Exception { 
    	...
    	if(!inDate.equals("")) where = where + " and t_teacher.inDate like '%" + inDate + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return teacherMapper.queryTeacher(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<Teacher> queryTeacher(String telephone,String teacherNo,String teacherName,String inDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!telephone.equals("")) where = where + " and t_teacher.telephone like '%" + telephone + "%'";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(!teacherName.equals("")) where = where + " and t_teacher.teacherName like '%" + teacherName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String telephone,String teacherNo,String teacherName,String inDate) throws Exception {
     	String where = "where 1=1";
    	if(!telephone.equals("")) where = where + " and t_teacher.telephone like '%" + telephone + "%'";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(!teacherName.equals("")) where = where + " and t_teacher.teacherName like '%" + teacherName + "%'";
