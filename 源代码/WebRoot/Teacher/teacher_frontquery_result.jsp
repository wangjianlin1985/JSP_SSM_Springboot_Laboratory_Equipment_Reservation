  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="teacher_inDate_edit" class="col-md-3 text-right">入职日期:</label>
		  	 <div class="col-md-9">
                <div class="input-group date teacher_inDate_edit col-md-12" data-link-field="teacher_inDate_edit" data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="teacher_inDate_edit" name="teacher.inDate" size="16" type="text" value="" placeholder="请选择入职日期" readonly>
		  ...
		  <div class="form-group">
		  	 <label for="teacher_teacherMemo_edit" class="col-md-3 text-right">教师介绍:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var teacher_teacherMemo_edit = UE.getEditor('teacher_teacherMemo_edit'); //教师介绍编辑器
	...
	$.ajax({
		...
		success : function (teacher, response, status) {
			if (teacher) {
				...
				$("#teacher_inDate_edit").val(teacher.inDate);
...
$(function(){
    ...
    /*入职日期组件*/
    $('.teacher_inDate_edit').datetimepicker({
    	language:  'zh-CN',  //语言
    	format: 'yyyy-mm-dd',
    	minView: 2,
    	weekStart: 1,
