...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">实验室管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>LabClass/frontlist">实验室类别</a></li>
                <li><a href="<%=basePath %>LabOrder/frontlist">实验室预约</a></li>
                <li><a href="<%=basePath %>DeviceLend/frontlist">设备借用</a></li>
                <li><a href="<%=basePath %>Student/frontlist">学生</a></li> -->
                 <li><a href="<%=basePath %>index.jsp">首页</a></li>
                <li><a href="<%=basePath %>Teacher/frontlist">师资力量</a></li>
                <li><a href="<%=basePath %>LabInfo/frontlist">实验室</a></li>
                <li><a href="<%=basePath %>Device/frontlist">实验室设备</a></li> 
                <li><a href="<%=basePath %>Experiment/frontlist">实验项目</a></li>
                <li><a href="<%=basePath %>TeachTask/frontlist">教学任务</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Experiment/studentFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的上课表查询</a></li> 
